...
- Compile flags: `-O2 -fms-runtime-lib=dll -D_CRT_SECURE_NO_WARNINGS`
- Link flags: `-fuse-ld=lld -fms-runtime-lib=dll`
...
| `target_clones` | function multiversioning with target_clones (x86-64) | Clang extension | ✅ (`-lclang_rt.builtins-x86_64`) | ✅ (`-lclang_rt.builtins-x86_64`) |  |
| `target_attribute_dispatch` | target("avx2,fma") functions chosen with __builtin_cpu_supports (x86-64) | Clang extension | ✅ (`-lclang_rt.builtins-x86_64`) | ✅ (`-lclang_rt.builtins-x86_64`) |  |
...
| `stacktrace` | std::stacktrace | P0881R7 | ✅ | ✅ |  |
...
| `experimental_simd` | std::experimental::simd (Parallelism TS 2) | N4808 | ❌ compile | ❌ compile | c++23: experimental_simd.cxx23.cpp:7:10: fatal error: 'experimental/simd' file not found; c++26: experimental_simd.cxx26.cpp:7:10: fatal error: 'experimental/simd' file not found |
...
| `aligned_accessor` | std::aligned_accessor for mdspan | P2897R7 | — | ❌ compile | c++26: aligned_accessor.cxx26.cpp:12:49: error: no member named 'aligned_accessor' in namespace 'std' |
| `dims` | std::dims | P2389R2 | — | ❌ compile | c++26: dims.cxx26.cpp:10:37: error: no member named 'dims' in namespace 'std' |
| `saturation_arithmetic` | add_sat, sub_sat, saturate_cast | P0543R3 | — | ❌ compile | c++26: saturation_arithmetic.cxx26.cpp:10:22: error: no member named 'add_sat' in namespace 'std' |
...
| `optional_ref` | std::optional<T&> | P2988R12 | — | ❌ compile | c++26: optional:74:26: error: union member '_Value' has reference type 'remove_cv_t<int &>' (aka 'int &') |
...
| `runtime_format` | std::runtime_format | P2918R2 | — | ❌ compile | c++26: runtime_format.cxx26.cpp:10:27: error: no member named 'runtime_format' in namespace 'std'; did you mean 'range_format'? |
...
| `span_at` | std::span::at | P2821R5 | — | ❌ compile | c++26: span_at.cxx26.cpp:13:25: error: no member named 'at' in 'std::span<int, 3>' |
...
| `c23_strdup` | strdup / strndup in <string.h> |  | ❌ compile | c23: c23_strdup.c23.c:8:13: error: use of undeclared identifier 'strndup'; did you mean 'strdup'? |
...
|---|---|---|
| c++23 | ✅ | C:\Program Files\Microsoft Visual Studio\18\Enterprise\VC\Tools\MSVC\14.51.36231\modules\std.ixx |
| c++26 | ✅ | C:\Program Files\Microsoft Visual Studio\18\Enterprise\VC\Tools\MSVC\14.51.36231\modules\std.ixx |
...
| `__cpp_trivial_union` | - | - |
| `__cpp_lib_mdspan` | 202207 | 202207 |
...
| `__cpp_lib_flat_map` | 202511 | 202511 |
| `__cpp_lib_flat_set` | 202511 | 202511 |
